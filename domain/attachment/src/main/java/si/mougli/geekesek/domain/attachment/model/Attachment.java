package si.mougli.geekesek.domain.attachment.model;
...
public class Attachment implements Identifiable, Timestampable, Serializable {
    ...
    private Attachment(String id, @NotNull String title, @NotNull String mimeType, @NotNull URL url, Date created) {
        this.id = id;
