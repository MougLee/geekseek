...
public class GraphDatabaseProducer
{
    ...
    private final String DATABASE_PATH_PROPERTY = "NEO4J.PATH";
    ...
    private String getDataBasePath()
    {
        ...
        if (path == null || path.isEmpty())
        {
            ...
            {
                throw new RuntimeException("Could not create temp location for Nepo4j Database. " + "Please provide environment variable " + DATABASE_PATH_PROPERTY + " with a valid path", e);
            }
        }
        return path;
    }
